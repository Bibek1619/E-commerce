...
export default function ProductTabs({ product, showFullDesc, setShowFullDesc }) {
  return (
    <div className="mt-12">
      <Tabs defaultValue="description" className="w-full">
        <TabsList className="grid grid-cols-3 w-full">
          <TabsTrigger value="description" className="cursor-pointer data-[state=active]:bg-orange-400 data-[state=active]:text-white">
            Description
          </TabsTrigger>
          <TabsTrigger value="specs" className="cursor-pointer data-[state=active]:bg-orange-400 data-[state=active]:text-white">
            Specifications
          </TabsTrigger>
          <TabsTrigger value="shipping" className="cursor-pointer data-[state=active]:bg-orange-400 data-[state=active]:text-white">
            Shipping
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="specs" className="mt-6">
          <Card>
            <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              {Object.entries(product.specifications || { Material: "Cotton", Color: "Black" }).map(([k, v]) => (
